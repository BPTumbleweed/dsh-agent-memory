...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function frame(theme, sessionId) {
			const q = "/dsh-agent-memory/panel?theme=" + theme +
		...
		function MemoryPanel(props) {
			...
			if (!canHook) return frame(detectTheme(), sessionId);
